...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        parser.add_argument(
            "--resume_opt",
            action="store_true",
            help="this will additionally load optimizer states",
        )
        parser.add_argument(
            "--resume_all",
            action="store_true",
        ...
        parser.add_argument("--legacy_load", action="store_true")
        parser.add_argument(
            "--start_epoch",
            type=int,
            default=None,
        ...
        parser.add_argument(
            "--nar_rand_window_expansion_factor", default=-1.0, type=float
        )
        parser.add_argument(
            "--nar_rand_window_translate", action="store_true", default=False
        )
        ...
        parser.add_argument(
            "--num_queries", default=10, type=int, help="Number of query slots"
        )
        ...
        parser.add_argument(
            ...
            type=float,
            default=0.07,
            help="temperature nce video_frame_contrastive_loss",
        )
        ...
        parser.add_argument(
            "--video_frame_contrastive_loss_coef",
            default=0.0,
            type=float,
        ...
        parser.add_argument(
            ...
            type=str,
            default="charades",
            help="vsldataset target task",
        )
        parser.add_argument(
            "--vsldataset_fv",
            type=str,
            default="new",
            help="[new | org] for visual features",
        )
        parser.add_argument(
        ...
        parser.add_argument(
            "--vslnet_datapath",
            type=str,
            default="vslnet_datapath",
            help="vsldataset path",
        )
        parser.add_argument(
            "--vslnet_thres_in_train",
            type=int,
            default=-1,
            help="exclude the windows less than vslnet_thres_in_train size",
        )
        ...
        parser.add_argument(
            "--conditioned_span_pred_num_heads",
            type=int,
            default=8,
            help="number of heads",
        )
        parser.add_argument(
            "--conditioned_span_pred_drop_rate",
            type=float,
            default=0.2,
            help="dropout rate",
        )
        parser.add_argument(
            "--conditioned_span_pred_predictor",
            type=str,
            default="bert",
            choices=["rnn", "bert", "justfc"],
        )

        # param for cross modal encoder
        parser.add_argument(
            "--num_cross_encoder_layers",
            default=2,
            type=int,
        ...
        parser.add_argument(
            ...
            type=str,
            default="gelu",
            help="activation in cross encoder for video side",
        )
        parser.add_argument(
            "--hidden_act",
            type=str,
            default="gelu",
            help="activation in cross encoder for text side",
        )
        ...
        parser.add_argument(
            ...
            type=float,
            default=0.1,
            help="dropout rate for cross encoder in video side",
        )
        parser.add_argument(
            "--hidden_dropout_prob",
            type=float,
            default=0.1,
            help="dropout rate for cross encoder in text side",
        )
        ...
        parser.add_argument(
            "--bi_hidden_size", default=256, type=int, help="bi_hidden_size"
        )

        parser.add_argument(
            "--v_target_size", default=2818, type=int, help="v_target_size"
        )
        ...
        parser.add_argument(
            ...
            type=float,
            default=0.1,
            help="dropout rate for cross encoder attention in video side",
        )
        parser.add_argument(
            "--attention_probs_dropout_prob",
            type=float,
            default=0.1,
            help="dropout rate for cross encoder attention in text side",
        )
        ...
        parser.add_argument(
            ...
            type=int,
            default=11296,
            help="number of ego4d train dataset",
        )

        parser.add_argument(
            "--optim_name", type=str, default="AdamW", choices=["AdamW", "BertAdam"]
        )
        ...
        parser.add_argument(
            ...
            type=int,
            nargs="+",
            help="num_scale_list " "scale list for multiscale strategy",
        )

        parser.add_argument("--allscaletopk", type=int, default=2, help="allscaletopk")
        parser.add_argument(
            "--NPM_score_norm",
            default=0,
            type=int,
        ...
        parser.add_argument(
            ...
            type=str,
            nargs="+",
            help="preds_list " "preds checkpoint list",
        )
        parser.add_argument(
    ...
    def parse(self):
        ...
        if isinstance(self, TestOptions):
            ...
            opt.results_dir = os.path.join(
                opt.results_root, "-".join([ctx_str, opt.exp_id])
            )
...
class TestOptions(BaseOptions):
    ...
    def initialize(self):
        ...
        self.parser.add_argument("--testing_gt_json", type=str, default="")
        ...
        self.parser.add_argument("--split", type=str, help="use_whichsplit for eval")
