...
from moment_detr.vslnet_utils.data_util import pad_seq, pad_char_seq, pad_video_seq
...
def train_collate_fn(data):
    ...
    if not isinstance(word_ids[0], list):
        # for tmp_item in word_ids:
        #     print(tmp_item["input_ids"])
        #     print(tmp_item["attention_mask"])
        #     print(tmp_item["token_type_ids"])
        # exit()
